...
public class Поликлиника
{
    ...
    public void ИзменитьВремяЗаписи(string имя, string фамилия, string отчество, DateTime новаяДата, TimeSpan новоеВремя)
    {
        var запись = записиНаПрием.FirstOrDefault(z => z.Пациент.Имя == имя && z.Пациент.Фамилия == фамилия && z.Пациент.Отчество == отчество);
        ...
        while (true)
        {
            ...
            switch (выбор)
            {
                ...
                case "5":
                    ...
                    string фамилияПациента = Console.ReadLine();
                    Console.WriteLine("Введите отчество пациента:");
                    string отчествоПациента = Console.ReadLine();
                    ...
                    поликлиника.ИзменитьВремяЗаписи(имяПациента, фамилияПациента, отчествоПациента, новаяДата, новоеВремя);
                    break;
