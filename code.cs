...
public class Поликлиника
{
    ...
    public bool ЗаписьНаПрием(Администратор администратор, Пациент пациент, DateTime дата, TimeSpan время)
    {
            ...
            switch (выбор)
            {
                case "1":
                    ...
                    else if (выборАдм == "3")
                    {
                        ...
                        if (пациент != null)
                        {
                            if (!поликлиника.ЗаписьНаПрием(администратор, пациент, желаемаяДата, желаемоеВремя))
                            {
